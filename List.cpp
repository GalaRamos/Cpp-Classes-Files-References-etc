...
insertion and deletion are quick. Normally, when we say a List, we talk about
doubly linked list. For implementing a singly linked list, we use forward list.
...
Functions used with List :
  ...
  -pop_front() – Removes the first element of the list, and reduces size of the
    list by 1
  -pop_back() – Removes the last element of the list, and reduces size of the
    list by 1
  -begin() – Returns an iterator pointing to the first element of the list
  -end() – Returns an iterator pointing to the theoretical last element which
    follows the last element
  -empty() – Returns whether the list is empty(1) or not(0)
  -insert() – Inserts new elements in the list before the element at a specified
    position
  -erase() – Removes a single element or a range of elements from the list
  -assign() – Assigns new elements to list by replacing current elements and
    resizes the list
